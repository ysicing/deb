...
默认构建 Go 1.27.1 版本，支持 amd64 和 arm64 架构。
...
```bash
./build.sh 1.27.1 "amd64 arm64 loong64"
```
...
```
build/amd64/ys-golang_1.27.1_amd64.deb
build/arm64/ys-golang_1.27.1_arm64.deb
```
...
```bash
# 安装 DEB 包
sudo dpkg -i ys-golang_1.27.1_amd64.deb
