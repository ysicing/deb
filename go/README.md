...
默认构建 Go 1.27.0 版本，支持 amd64 和 arm64 架构。
...
```bash
./build.sh 1.27.0 "amd64 arm64 loong64"
```
...
```
build/amd64/ys-golang_1.27.0_amd64.deb
build/arm64/ys-golang_1.27.0_arm64.deb
```
...
```bash
# 安装 DEB 包
sudo dpkg -i ys-golang_1.27.0_amd64.deb
